    ...
    return (
        <div style={{ width: '100%', paddingBottom: '2rem' }}>
            ...
            <div style={{ background: 'rgba(255,255,255,0.05)', padding: '1rem', borderRadius: 'var(--radius-sm)', borderLeft: '3px solid var(--accent-primary)', fontSize: '0.85rem', lineHeight: '1.5', color: 'var(--text-secondary)', marginBottom: '1.5rem' }}>
                <strong style={{ color: '#ffffff' }}>The Ambassador Journey</strong> Supporting for-good businesses isn't just a transaction — it's a lifestyle of conviction. Your Network Tier rises as you collect Tokens of Empathy through active discovery and community building. From Scout to Legend, every badge earned proves that conviction-driven consumers are real. Higher Tiers unlock experiential privileges like exclusive founders' dinners and behind-the-scenes access.
            </div>
